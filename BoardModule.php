...
include_once __DIR__.'/board_helpers.php';
 ...
 */
class BoardModule extends \yii\base\Module
{
    ...
    public $controllerNamespace = 'modules\board\controllers';
    public $viewList;
    public $layoutList;
