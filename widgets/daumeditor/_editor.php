...
#$baseurl = \Yii::$app->assetManager->getPublishedUrl('');
$baseurl = $this->_assetBundle->baseUrl; 
$bbsdata_id = $this->model->id; 
	...
	<div id="tx_sidebar" class="tx-sidebar">
		<div class="tx-sidebar-boundary">
			...
			<ul class="tx-bar tx-bar-left tx-nav-attach">
				...
				<li class="tx-list kimsq_icon">
					<span id="onIcon1" onclick="OpenWindow('/_core/plugin/editor/daumeditor/photo_uploader/popup/index.html');"><img src="/_core/image/_public/ico_file.gif" alt="" /> 사진</span>
					<!--
					<span id="onIcon1" onclick="OpenWindow('/bbs/media-browser/index?editor=1&multiple=1&callback=&bbsdata_id=<?= $bbsdata_id ?>');"><img src="/_core/image/_public/ico_file.gif" alt="" /> 사진</span>
					-->
				</li>
				
				<!--
				<li class="tx-list kimsq_icon">
					<span id="onIcon2" onclick="OpenWindow('');"><img src="/_core/image/_public/ico_xfile.gif" alt="" />파일</span>
					<span id="offIcon2" style="display:none;color:#bdbdbd" ><img src="/_core/image/_public/ico_photo.gif" alt="" />파일</span>
				</li>
				-->
				<li class="tx-list kimsq_icon">
					<span id="onIcon2" onclick="OpenWindow('/_core/plugin/editor/daumeditor/photo_uploader/popup/file_uploader.html');"><img src="/_core/image/_public/ico_xfile.gif" alt="" /> 파일</span>
				</li>
				...
				<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
					...
					<div class="tx-menu-footer">
						<img class="tx-menu-confirm"
							 src="<?= $baseurl ?>/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
						<img class="tx-menu-cancel" hspace="3"
							 src="<?= $baseurl ?>/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
					</div>
				</div>
			</li>
			<li class="tx-list">
...
<div id="tx_loading" class="tx-loading"><div><img src="<?= $baseurl ?>/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
...
<img id="tx_resize_holder" src="<?= $baseurl ?>/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
</div>
<!-- 편집영역 끝 -->
...
<div id="tx_attach_box" class="tx-attach-box">
	<div class="tx-attach-box-inner">
		<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="<?= $baseurl ?>/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
